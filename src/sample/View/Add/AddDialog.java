 ...
 */
public class AddDialog implements EventHandler<ActionEvent>{
    private Stage newWindow;
    private Stage stage;
    private ControllerStudents controllerStudents;
    private Table table;
    public AddDialog(Stage stage, ControllerStudents controllerStudents, Table table){
        this.stage = stage;
    ...
    public void handle(ActionEvent event) {
        ...
        findButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                controllerStudents.addStudent(new Student(fioText.getText(),nameText.getText(),patronymicText.getText(),groupText.getText(),list));
